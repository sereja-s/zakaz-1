...
<section class="vintage" id="svarka">
	<div class="vintage__row">
		<div class="vintage__img-part">
			<div>
				<img class="vintage__ico" src="assets/img/content/img_1_1.png" alt="">
			</div>
		</div>
		<div class="vintage__text-part">
			...
			<div class="vintage__text-part-img">
			</div>
		</div>
	</div>
</section>
...
<section class="boriosa" id="santehnika">
	<div class="boriosa__row">
		<div class="boriosa__text-part">
			...
			<div class="boriosa__text-part-img">
			</div>
		</div>
		<div class="boriosa__img-part">
			<div>
				<img class="boriosa__ico" src="assets/img/content/img_4_1.png" alt="">
			</div>
		</div>
	</div>
</section>
...
<section class="retro" id="elektrika">
	<div class="retro__row">
		...
		<div class="retro__text-part">
			...
			<div class="retro__text-part-img">
			</div>
		</div>
		<div class="retro__img-part-right"></div>
	</div>
</section>
